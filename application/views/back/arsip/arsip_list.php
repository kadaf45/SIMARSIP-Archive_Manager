            ...
            <table id="dataTable" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php $no = 1; foreach($get_all as $data){
                  ...
                  // action
                  $edit = '<a href="'.base_url('arsip/update/'.$data->id_arsip).'" class="btn btn-sm btn-warning"><i class="fa fa-pencil"></i></a>';
                  $delete = '<a href="'.base_url('arsip/delete/'.$data->id_arsip).'" onClick="return confirm(\'Are you sure?\');" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>';
                ?>
                  <tr>
